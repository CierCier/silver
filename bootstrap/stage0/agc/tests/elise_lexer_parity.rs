...
fn corpus() -> Vec<(String, String)> {
    // Repository root: first ancestor containing std/ (post-migration layout).
...
fn legacy_class(token: &lexer::Token) -> &'static str {
    ...
    match token {
        ...
        T::BitwiseAndAssign => "BitAndAssign",
        T::BitwiseOrAssign => "BitOrAssign",
        T::BitwiseXorAssign => "BitXorAssign",
        T::LeftShiftAssign => "ShlAssign",
        T::RightShiftAssign => "ShrAssign",
        T::BitwiseAnd => "BitAnd",
        T::BitwiseOr => "BitOr",
        T::BitwiseXor => "BitXor",
        T::BitwiseNot => "BitNot",
...
const TOK_NAMES: &[(u16, &'static str)] = &[
    ...
    (Tok::BitAndAssign as u16, "BitAndAssign"),
    (Tok::BitOrAssign as u16, "BitOrAssign"),
    (Tok::BitXorAssign as u16, "BitXorAssign"),
    (Tok::ShlAssign as u16, "ShlAssign"),
    (Tok::ShrAssign as u16, "ShrAssign"),
